...
// Import your images
const images = [
    '../assets/paintings/1.jpg',
    '../assets/paintings/2.jpg',
    '../assets/paintings/3.jpg',
    '../assets/paintings/4.jpg',
    '../assets/paintings/5.jpg',
    '../assets/paintings/6.jpg',
    '../assets/paintings/7.jpg',
    '../assets/paintings/8.jpg'
    ...
    <ScrollView style={styles.container}>
      <View style={styles.topContent}>
        <View style={styles.headerContainer}>
          ...
          <Image source={'../assets/images/WoofleMoffBlank.png'} style={styles.logo} />
      ...
      <View style={styles.bottomContent}>
        <Text style={styles.footerText}>Send an email to erike@uchicago.edu if you are interested in purchasing any of the paintings</Text>
      </View>
    </ScrollView>
  );
}
